...
const NewNote = ({ folder, token, setAllData, note }) => {
   ...
   <KeyboardAvoidingView style={styles.container}>
    ...
    <View style={styles.controlBar}>
     <Pressable onPress={() => handleFormat("heading")} style={styles.btn}>
      <Icon
       name="heading"
       style={[styles.white, selected.includes("heading") && styles.selected]}
      />
     </Pressable>
     ...
     <Pressable onPress={() => handleFormat("underline")} style={styles.btn}>
      <Icon name="underline" style={styles.white} />
     </Pressable>
     <Text style={styles.seperator}> | </Text>
     <Pressable onPress={() => handleFormat("alignLeft")} style={styles.btn}>
      <Icon name="align-left" style={styles.white} />
     </Pressable>
     <Pressable onPress={() => handleFormat("alignCenter")} style={styles.btn}>
      <Icon name="align-center" style={styles.white} />
     </Pressable>
     <Pressable onPress={() => handleFormat("alignRight")} style={styles.btn}>
