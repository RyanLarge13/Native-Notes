			...
			>
				...
				>
					...
					>
						...
						{notesToRender.length === 1 ? "note" : "notes"}
					</Text>
						...
						{notesToRender.length > 0 ? (
							<View
								style={[
									...
									view ? styles.notesGrid : styles.notesList,
								]}
							>
...
const EmptyNotes = ({ colors, accent, trashed }) => {
	return (
		<View style={styles.emptyState}>
			...
			>
				<Feather
					name={trashed ? "trash-2" : "file-text"}
					size={23}
					color={accent}
				/>
			</View>
