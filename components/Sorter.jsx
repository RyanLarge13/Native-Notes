...
const Sorter = ({
 ...
 return (
  <View style={styles.container}>
   ...
   >
    <Icon name="sort-amount-desc" style={darkMode ? styles.white : styles.black} />
   ...
   >
    <Pressable
     ...
     style={[styles.typeBtn, filter === "Title" && { backgroundColor:darkMode?
     "#222" : "#aaa"}]}
    >
    ...
    <Pressable
     ...
     style={[
      styles.typeBtn,
      filter === "Date" && { backgroundColor: darkMode ? "#222" : "#aaa" }
     ]}
    >
    ...
    <Pressable
     ...
     style={[
      styles.typeBtn,
      filter === "Update" && { backgroundColor:darkMode? "#222" : "#aaa" }
     ]}
    >
