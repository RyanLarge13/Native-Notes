     ...
     <View>
      ...
      <View style={styles.notesBtnContainer}>
       <Pressable
        ...
        style={[styles.btn, { backgroundColor: darkMode ? "#111" : "#fff" }]}
       >
       ...
       >
        ...
        <Icon name="lock" style={darkMode ? styles.white : styles.black} />
       </Pressable>
       <Pressable
        style={[styles.btn, { backgroundColor: darkMode ? "#111" : "#fff" }]}
       >
        ...
        <Icon name="share-alt" style={darkMode ? styles.white : styles.black} />
       </Pressable>
       <Pressable
        onPress={() => {
       ...
       >
        ...
        <Icon name="trash" style={darkMode ? styles.white : styles.black} />
       </Pressable>
      </View>
      <Text
       style={[
