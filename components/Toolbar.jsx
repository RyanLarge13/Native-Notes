...
const Toolbar = ({ webviewRef, darkMode, theme }) => {
 ...
 return (
  <>
    ...
    <View style={[styles.optionsContainer]}>
     ...
     <View style={styles.selectGroup}>
      ...
      <Pressable
       ...
       style={styles.btn}
      >
       <Icon name="align-center" style={[styles.white, styles.iconSize]} />
      </Pressable>
      <Pressable
       onPress={() => handleFormat("alignRight", setTextOptions)}
       style={styles.btn}
      >
       <Icon name="align-right" style={[styles.white, styles.iconSize]} />
      </Pressable>
     </View>
     <View style={styles.selectGroup}>
      <Pressable
   ...
   <ScrollView
    horizontal={true}
    style={[styles.container, { backgroundColor: darkMode ? "#000" : "#eee" }]}
   >
    <Pressable onPress={() => handleFormat("undo", null)} style={styles.btn}>
     <Icon name="undo" style={[styles.white, styles.iconSize]} />
    </Pressable>
    <Pressable onPress={() => handleFormat("redo", null)} style={styles.btn}>
     <Icon name="redo" style={[styles.white, styles.iconSize]} />
    </Pressable>
    <Pressable onPress={() => setTextOptions(prev => !prev)} style={styles.btn}>
     <Icon name="text-height" style={[styles.white, styles.iconSize]} />
    </Pressable>
    <Pressable onPress={() => setFontColor(prev => !prev)} style={styles.btn}>
