...
const Options = ({ setOptions, options, darkMode }) => {
 ...
 return (
  ...
  >
   <Pressable
    ...
    style={styles.btn}
   >
    <Text style={[darkMode? styles.white : styles.black, {marginHorizontal: 20 }]}>New folder</Text>
   ...
   <Pressable
    ...
    style={styles.btn}
   >
    <Text style={[darkMode ? styles.white :styles.black, {marginHorizontal: 20}]}>New note</Text>
