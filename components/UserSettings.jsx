...
const UserSettings = ({
  ...
  const newNotifs = [
   {
    ...
    text:
     "Are you sure you want to delete your account? Once you delete your account your data will be lost forever and you cannot get it back",
    actions: [
     { text: "cancel", func: () => setSystemNotifs([]) },
 ...
 const setColorAndPreferences = async (newColor, trigger) => {
  ...
  setTheme({ on: trigger, color: color });
  try {
   db.runAsync(
    `
                      UPDATE user SET preferences = ? WHERE userId = ?
 ...
 return (
  <>
   ...
   <Animated.View
    style={[
     styles.container,
     { backgroundColor: darkMode ? "#000" : "#eee", translateX: transXAni }
    ]}
   >
    <ScrollView
    ...
    >
     ...
     >
      <Text style={darkMode ? styles.white : styles.black}>Dark Mode (beta)</Text>
      <Switch
     ...
     <View style={[
      ...
      <Text style={darkMode ? styles.white : styles.black}>Theme (beta)</Text>
      <Switch
     ...
     <View style={[
      ...
      <Text style={darkMode ? styles.white : styles.black}>Grid View</Text>
      <Switch
       trackColor={{ false: "#fda4af", true: "#6ee7b7" }}
     ...
     <View style={styles.hr}></View>
     <View>
      <Text style={[styles.heading, darkMode ? styles.white : styles.black]}>
       System
      </Text>
      <View style={[
       styles.switchBtn,
      ...
      <View style={[
       ...
       <Text style={darkMode ? styles.white : styles.black}>Lock App</Text>
       <Switch
        trackColor={{ false: "#fda4af", true: "#6ee7b7" }}
      ...
      <View style={[
       ...
       <Text style={darkMode ? styles.white : styles.black}>Save Location</Text>
       <Switch
        trackColor={{ false: "#fda4af", true: "#6ee7b7" }}
