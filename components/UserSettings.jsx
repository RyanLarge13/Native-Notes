   ...
   <Animated.View style={[styles.container, { translateX: transXAni }]}>
    ...
    >
     <View style={styles.stickyHeader}>
      <Text style={[styles.white, styles.heading]}>Theme & Style</Text>
     </View>
     ...
     <View style={styles.stickyHeader}>
      <Text style={[styles.white, styles.heading]}>View & Order</Text>
     </View>
     <View style={styles.switchBtn}>
     ...
     <View style={styles.hr}></View>
     <View>
      <Text style={[styles.heading, styles.white]}>System</Text>
      <View style={styles.switchBtn}>
      ...
      <View style={styles.switchBtn}>
       <Text style={styles.white}>Save Location</Text>
       <Switch
        trackColor={{ false: "#fda4af", true: "#6ee7b7" }}
        thumbColor={appLock ? "#5effa7" : "#ff808d"}
        ios_backgroundColor="#000000"
